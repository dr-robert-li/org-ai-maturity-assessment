...
> **Purpose**: Assess an individual's AI fluency across a set of role-relevant domains, using four standard levels: **Learning**, **Competent**, **Practitioner**, **Power-User**. Use this rubric alongside the companion checklists:
>
...
>
> **Relationship to the org assessment**: Individual domain scores roll up into the [MIT CISR AI Maturity Self-Assessment](../org-assessment/ai-maturity-self-assessment.md) via a documented mapping.
...
- **Practitioner**
  Designs and improves workflows that incorporate Claude. Proactively evaluates outputs and updates prompts/skills based on error patterns. Shares working prompts/skills with others and adapts them to new situations.
...
1. **Assign numeric values to levels**: Learning = 1, Competent = 2, Practitioner = 3, Power-User = 4.
...
4. **For the organisation**:
   ...
   - Combine with the org-level Yes/No self-assessment to get a full picture.
...
| Domain | Track | Level (L/C/P/PU) | Score (1–4) | Evidence / Notes |
|--------|-------|:----------------:|:-----------:|------------------|
...
### Learning (1) in any domain → Priority gap

| Domain at Learning | Recommended Actions |
|--------------------|---------------------|
| Foundations — Basic Usage | Pair the person with a Practitioner for a 30-minute onboarding session. Install Claude Desktop / Claude Code, set up Projects, and complete one real task together. |
...
| Collaboration | Invite them to the team AI channel. Pair with a Practitioner or Power-User to observe their workflow. |
...
### Competent (2) → Strengthening opportunity

| Domain at Competent | Recommended Actions |
|---------------------|---------------------|
...
### Practitioner (3) → Scale

| Domain at Practitioner | Recommended Actions |
|------------------------|---------------------|
| Any domain | Encourage them to lead show-and-tells, contribute skills or CLAUDE.md patterns, and mentor one Competent peer. |

### Power-User (4) → Champion & strategy

| Domain at Power-User | Recommended Actions |
|----------------------|---------------------|
| Any domain | Position as internal champion. Involve in org-level strategy, policy drafting, and cross-team enablement. |
...
|--------|-------|:-----:|----------|
| Foundations — Basic Usage | Competent | 2 | Uses Claude Desktop daily; has created several Artifacts; not yet using Projects consistently. |
| Prompting & Communication | Competent | 2 | Clear role/task prompts; rarely iterates or uses multi-turn. |
| Role-Relevant Applications | Practitioner | 3 | Uses Claude for drafts, data interpretation, and weekly summaries. |
| Strategy & Value in My Role | Competent | 2 | Can name time saved on emails; has not yet proposed a new use case. |
| Working With Data | Learning | 1 | Loose understanding of sources of truth; rarely cross-checks numbers. |
| Collaboration & Team Behaviour | Learning | 1 | Mostly a solo user; has not shared prompts with the team. |
| Safety & Critical Thinking | Competent | 2 | Understands broad data risks; no documented team norms. |
| **Average** | | **1.9** | **Competent-leaning** — solid individual use; priority is data literacy and team leverage. |

### Recommendations from this example

1. **Priority 1** (Working With Data, Collaboration): Walk through team's sources of truth; invite to team AI channel; pair with a Practitioner.
